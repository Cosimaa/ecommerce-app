                ...
                <div className="add-product">
                    <form action="" id="create">
                        ...
                        <select name="category" id="category">
                            ...
                            <option value="Phụ tùng gắn máy">Phụ tùng gắn máy</option>
                            <option value="Đồ Inox">Đồ Inox</option>
                        </select>
                        <input type="text" name="price" placeholder='giá bán'/>
                        <div className="choose-image">
                            { selectedImage && <img src={selectedImage} alt=''/>}    
                            <input type="file" name="upload-image" onChange={handleImageChange} accept='image/*'/>                       
                        </div>
                        <textarea name="description" id="description" placeholder='mô tả sản phẩm' rows={10} cols={88}></textarea>
